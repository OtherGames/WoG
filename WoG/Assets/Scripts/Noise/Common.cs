...
namespace Unity.Mathematics
{
    ...
    public static partial class noise
    {
        ...
        static float k2 = 289f;//289
        static float mod289(float x) { return x - floor(x * (1.0f / k2)) * k2; }
        static float2 mod289(float2 x) { return x - floor(x * (1.0f / k2)) * k2; }
        static float3 mod289(float3 x) { return x - floor(x * (1.0f / k2)) * k2; }
        static float4 mod289(float4 x) { return x - floor(x * (1.0f / k2)) * k2; }
        ...
        static float k1 = 34f;
        static float permute(float x) { return mod289((k1 * x + 1.0f) * x); }
        static float3 permute(float3 x) { return mod289((k1 * x + 1.0f) * x); }
        static float4 permute(float4 x) { return mod289((k1 * x + 1.0f) * x); }
